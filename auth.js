...
function setAuthMode(mode) {
  ...
  if (subtitle) {
    subtitle.textContent = isSignup
      ? 'Create a free Rolling Mill World account.'
      : 'Sign in to your Rolling Mill World account.';
  }
  ...
  if (toggle) {
    toggle.innerHTML = isSignup
      ...
      : 'New to Rolling Mill World? <button type="button" onclick="setAuthMode(\'signup\')">Create an account</button>';
  }
